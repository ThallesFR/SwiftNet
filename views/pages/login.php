...
<main id="mainLogin">
    ...
    <form id="form_login" method="POST" action="login-fgdfgr546-auth">
        ...
        <input id="input_login" name="usuario_login" placeholder="Login" type="text" maxlength="6"><br>
        <input id="input_senha_login" name="senha" placeholder="Senha" type="password" maxlength="8"><br>
