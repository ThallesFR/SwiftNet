...
<main id="mainhome">
    ...
    <section id="sectionHome">
        <h1 id="servicos-titulo">
            Soluções inteligentes para a sua casa
        </h1>

        <div id="planosHome">

            <a class="containerCard" href="http://localhost/SwiftNet/planos#fibraPlanos">
                ...
                <h4 class="titulo">Fibra</h4>
                <p class="descricao">
                    Soluções de internet em fibra com alta qualidade e disponibilidade.
                </p>
            </a>

            <a class="containerCard" href="http://localhost/SwiftNet/planos#fixoPlanos">
                ...
                <h4 class="titulo">Fixo</h4>
                <p class="descricao">
                    Variedade e qualidade de planos para a sua telefonia fixa.
                </p>
            </a>

            <a class="containerCard" href="http://localhost/SwiftNet/planos#movelPlanos">
                ...
                <h4 class="titulo">Movel</h4>
                <p class="descricao">
                    Monte planos de celular personalizados para sua empresa.
                </p>
            </a>
        </div>
    </section>
