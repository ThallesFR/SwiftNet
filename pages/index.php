    ...
    <main id="mainhome">
        ...
        <section id="sectionHome" >
            ...
            <div id="planosHome">
                    ...
                    <a class="containerCard" href="../pages/planos.php#fibraPlanos">
                    ...
                    <a class="containerCard" href="../pages/planos.php#fixoPlanos">
                    ...
                    <a class="containerCard" href="../pages/planos.php#movelPlanos">
